...
if uploaded_file is not None:
    ...
    # Convertir les dates et heures en objets datetime pour comparaison
    ...
    objectif = st.sidebar.number_input("🔢 Entrez l'objectif de consommation énergétique (kWh)", min_value=100.0, max_value=250.0, step=0.01, format="%.2f")
    prix_gn = st.sidebar.number_input("🔢 Entrez l'objectif le prix du Mwh Gaz Naturel (€/MWh)", min_value=0.0, max_value=250.0, step=0.01, format="%.2f")
